...
public class EntityAdapter extends RecyclerView.Adapter<EntityAdapter.EntityTileViewHolder> {
    ...
    public EntityTileViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.title_entity, parent, false);
...
//            }
            ...
            if (entity.isSensor()) {
                setColor(R.color.common_google_signin_btn_text_dark_disabled);
...
//                                    mTextState.setTextColor(ResourcesCompat.getColor(context.getResources(), R.color.md_red_500, null));
                ...
                setColor(R.color.design_default_color_primary);
            } else {
                setColor(R.color.common_google_signin_btn_text_dark_focused);
            }


            if (entity.isCircle()) {
                //mCardView.setCardBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.md_blue_A200, null));
                mCardView.setCardBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.common_google_signin_btn_tint, null));
                setColor(R.color.common_google_signin_btn_text_dark_focused);
            } else {
                mCardView.setCardBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.common_google_signin_btn_tint, null));
            }
