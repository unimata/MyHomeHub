...
public class DeviceDiscoveryUPnP extends AsyncTask {
    ...
    private DeviceDiscoveryUPnP(Activity activity, OnDiscoveryListener listener) {
    ...
    private DeviceDiscoveryUPnP(Activity activity, OnDiscoveryListener listener, String customQuery, String address, int port) {
        mContext = activity.getApplicationContext();
        mActivity = activity;
        mListener = listener;
        mTheardsCount = 0;
    ...
    public static boolean discoveryDevices(Activity activity, OnDiscoveryListener listener) {
        DeviceDiscoveryUPnP discover = new DeviceDiscoveryUPnP(activity, listener);
        discover.execute();
        try {
